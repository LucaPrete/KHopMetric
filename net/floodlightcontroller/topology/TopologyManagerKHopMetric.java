...
public class TopologyManagerKHopMetric implements 
    ...
    protected TopologyInstanceKHopMetric currentInstance;
    protected TopologyInstanceKHopMetric currentInstanceWithoutTunnels;
    ...
    protected boolean createNewInstance() {
        ...
        TopologyInstanceKHopMetric nt = new TopologyInstanceKHopMetric(switchPorts, 
                                                   blockedPorts,
                                                   openflowLinks, 
    ...
    */
    ...
    public TopologyInstanceKHopMetric getCurrentInstance(boolean tunnelEnabled) {
        if (tunnelEnabled)
            return currentInstance;
        else return this.currentInstanceWithoutTunnels;
    }

    public TopologyInstanceKHopMetric getCurrentInstance() {
